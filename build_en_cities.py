...
<p>I'm Sundsvall's slice of the Guilty Pleasure family: the same New York-inspired comfort bistro soul as the flagship in Umeå, but with a rhythm of my own. The stone houses of Stenstan and the pulse of Storgatan set the tone — you come here for a long weekend brunch, a dinner in no particular hurry, or a Friday night that grows into something more. Fridays and Saturdays I'm open until midnight.</p>
...
UMEA_FAQ_EN = [
  ...
  ("What are the opening hours at GP's in Umeå?","Monday–Tuesday 11–22, Wednesday–Thursday 11–23, Friday 11–midnight, Saturday 11:30–midnight and Sunday 11:30–22. Fridays and Saturdays run until midnight."),
...
SUNDSVALL_FAQ_EN = [
  ...
  ("What are the opening hours at GP's in Sundsvall?","Monday–Tuesday 11–21, Wednesday–Thursday 11–22, Friday–Saturday 11–midnight and Sunday 11–21. Weekend nights run until midnight."),
...
def city_page_en(key):
    ...
    desc = (f"New York-inspired comfort bistro at {c['street']}, {c['name']}, Sweden. Brunch, dinner & disco. "
            + ("Walk-ins only, dogs welcome. Open till midnight Fri–Sat." if key=="umea"
               else "Book online or walk in — dogs welcome. Open till midnight Fri–Sat."))
